...
/// Converts V1 ASN.1 model objects to version-independent API objects
public enum ASNToAPIDecoderV1 {

    /// Convert a V1 UicRailTicketData to the version-independent API representation
    static func decode(_ asn: UicRailTicketDataV1) -> SimpleUicRailTicket {
    ...
    static func convertIssuingDetail(_ asn: IssuingDataV1) -> SimpleIssuingDetail {
    ...
    static func convertTravelerDetail(_ asn: TravelerDataV1) -> SimpleTravelerDetail {
    ...
    static func convertTraveler(_ asn: TravelerTypeV1) -> SimpleTraveler {
        ...
        // V1 has yearOfBirth and dayOfBirth (day of year), but NO monthOfBirth
        if let year = asn.yearOfBirth {
            if let dayOfYear = asn.dayOfBirth, dayOfYear > 0 {
                // dayOfBirth in V1 is day-of-year (1..366)
                let cal = Calendar(identifier: .gregorian)
                let utc = TimeZone(identifier: "UTC")!
                if let jan1 = cal.date(from: DateComponents(timeZone: utc, year: year, month: 1, day: 1)),
                   let date = cal.date(byAdding: .day, value: dayOfYear - 1, to: jan1) {
                    t.dateOfBirth = date
                }
            } else {
                // Only year known
    ...
    static func convertControlDetail(_ asn: ControlDataV1) -> SimpleControlDetail {
    ...
    static func convertDocument(_ asn: DocumentDataV1, issuingDate: Date?) -> APIDocumentData? {
    ...
    static func convertReservation(_ asn: ReservationDataV1, token: TokenTypeV1?, issuingDate: Date? = nil) -> Reservation {
        let r = Reservation()
    ...
    static func convertOpenTicket(_ asn: OpenTicketDataV1, token: TokenTypeV1?, issuingDate: Date? = nil) -> OpenTicket {
        let o = OpenTicket()
    ...
    static func convertPass(_ asn: PassDataV1, token: TokenTypeV1?, issuingDate: Date? = nil) -> Pass {
        let p = Pass()
    ...
    static func convertCarCarriageReservation(_ asn: CarCarriageReservationDataV1, token: TokenTypeV1?, issuingDate: Date? = nil) -> CarCarriageReservationAPI {
        ...
        if let rrt = asn.roofRackType { c.roofRackType = RoofRackType(rawValue: rrt.rawValue) }
    ...
    static func convertCustomerCard(_ asn: CustomerCardDataV1, token: TokenTypeV1?) -> CustomerCardAPI {
    ...
    static func convertCounterMark(_ asn: CountermarkDataV1, token: TokenTypeV1?, issuingDate: Date? = nil) -> CounterMarkAPI {
    ...
    static func convertParkingGround(_ asn: ParkingGroundDataV1, token: TokenTypeV1?, issuingDate: Date? = nil) -> ParkingGroundAPI {
        ...
        p.toParkingDate = DateTimeUtils.getDate(issuingDate: issuingDate, dayOffset: (asn.fromParkingDate ?? 0) + (asn.untilParkingDate ?? 0), time: nil)
    ...
    static func convertFIPTicket(_ asn: FIPTicketDataV1, token: TokenTypeV1?, issuingDate: Date? = nil) -> FIPTicketAPI {
        let f = FIPTicketAPI()
    ...
    static func convertStationPassage(_ asn: StationPassageDataV1, token: TokenTypeV1?, issuingDate: Date? = nil) -> StationPassageAPI {
    ...
    static func convertDelayConfirmation(_ asn: DelayConfirmationV1, token: TokenTypeV1?) -> DelayConfirmationAPI {
        let d = DelayConfirmationAPI()
        d.token = convertToken(token)

        d.plannedArrivalDate = dateFromDayOfYear(year: asn.departureYear ?? 0, day: asn.departureDay ?? 0, time: asn.departureTime)
    ...
    static func convertVoucher(_ asn: VoucherDataV1, token: TokenTypeV1?) -> VoucherAPI {
        let v = VoucherAPI()
    ...
    static func convertDocumentExtension(_ asn: ExtensionDataV1) -> DocumentExtensionAPI {
    ...
    static func convertToken(_ asn: TokenTypeV1?) -> TokenAPI? {
    ...
    static func convertExtension(_ asn: ExtensionDataV1) -> TicketExtension {
    ...
    static func convertGeoCoordinate(_ asn: GeoCoordinateTypeV1) -> GeoCoordinateAPI {
    ...
    static func convertCardReference(_ asn: CardReferenceTypeV1) -> CardReferenceAPI {
    ...
    static func convertTicketLink(_ asn: TicketLinkTypeV1) -> TicketLinkAPI {
        var t = TicketLinkAPI()
    ...
    static func convertPlaces(_ asn: PlacesTypeV1) -> PlacesAPI {
        var p = PlacesAPI()
        p.coach = asn.coach
    ...
    static func convertCompartmentDetails(_ asn: CompartmentDetailsTypeV1) -> CompartmentDetailsAPI {
    ...
    static func convertBerth(_ asn: BerthDetailDataV1) -> BerthAPI {
        var b = BerthAPI()
    ...
    static func convertTariff(_ asn: TariffTypeV1) -> TariffAPI {
        var t = TariffAPI()
    ...
    static func convertSeriesDetail(_ asn: SeriesDetailTypeV1) -> SeriesDetailAPI {
    ...
    static func convertVatDetail(_ asn: VatDetailTypeV1) -> VatDetailAPI {
        var v = VatDetailAPI()
    ...
    static func convertLuggageRestriction(_ asn: LuggageRestrictionTypeV1) -> LuggageRestrictionAPI {
    ...
    static func convertRegionalValidity(_ asn: RegionalValidityTypeV1) -> RegionalValidityAPI? {
    ...
    static func convertTrainLink(_ asn: TrainLinkTypeV1) -> TrainLinkAPI {
        var t = TrainLinkAPI()
    ...
    static func convertViaStation(_ asn: ViaStationTypeV1) -> ViaStationAPI {
        var v = ViaStationAPI()
    ...
    static func convertZone(_ asn: ZoneTypeV1) -> ZoneAPI {
        var z = ZoneAPI()
    ...
    static func convertLine(_ asn: LineTypeV1) -> LineAPI {
        var l = LineAPI()
    ...
    static func convertPolygone(_ asn: PolygoneTypeV1) -> PolygoneAPI {
        var p = PolygoneAPI()
    ...
    static func convertReturnRouteDescription(_ asn: ReturnRouteDescriptionTypeV1) -> ReturnRouteDescriptionAPI {
    ...
    static func convertIncludedOpenTicket(_ asn: IncludedOpenTicketTypeV1) -> IncludedOpenTicketAPI {
    ...
    static func convertValidityDetails(_ asn: ValidityPeriodDetailTypeV1) -> ValidityDetailsAPI {
        var v = ValidityDetailsAPI()
        if let periods = asn.validityPeriod {
            v.validityPeriods = periods.map { _ in
