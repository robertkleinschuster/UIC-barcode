...
struct ControlDataV1: ASN1Decodable {
    static let hasExtensionMarker = true
    static let optionalFieldCount = 6

    var identificationByCardReference: [CardReferenceTypeV1]?
    ...
    var infoText: String?
    var includedTickets: [TicketLinkTypeV1]?
    ...
    init(from decoder: inout UPERDecoder) throws {
        ...
        if presence[5] { extensionData = try ExtensionDataV1(from: &decoder) }
...
extension ControlDataV1: ASN1Encodable {
