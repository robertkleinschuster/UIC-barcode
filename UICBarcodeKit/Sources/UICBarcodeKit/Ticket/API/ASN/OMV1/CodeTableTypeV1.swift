...
/// Code table type for station codes (V1: 5 values, NO extension marker)
enum CodeTableTypeV1: Int, ASN1Decodable {
    case stationUIC = 0
    ...
    init(from decoder: inout UPERDecoder) throws {
        ...
        guard let value = CodeTableTypeV1(rawValue: rawValue) else {
            throw UICBarcodeError.asn1DecodingError("Invalid CodeTableTypeV1: \(rawValue)")
        }
        self = value
    }
}
