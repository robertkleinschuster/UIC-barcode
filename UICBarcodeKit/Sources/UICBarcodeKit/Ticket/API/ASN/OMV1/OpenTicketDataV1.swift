...
struct OpenTicketDataV1: ASN1Decodable {
    ...
    var returnDescription: ReturnRouteDescriptionTypeV1?
    ...
    var infoText: String?
    var includedAddOns: [IncludedOpenTicketTypeV1]?
    ...
    init(from decoder: inout UPERDecoder) throws {
        ...
        // 38 optional+default fields; returnIncluded is mandatory
        let presence = try decoder.decodePresenceBitmap(count: 38)
        var idx = 0
        ...
        if presence[idx] { returnDescription = try ReturnRouteDescriptionTypeV1(from: &decoder) }; idx += 1
...
// MARK: - OpenTicketDataV1 Encoding

extension OpenTicketDataV1: ASN1Encodable {
