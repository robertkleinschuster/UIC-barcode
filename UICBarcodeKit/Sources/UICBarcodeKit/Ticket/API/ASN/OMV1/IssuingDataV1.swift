...
struct IssuingDataV1: ASN1Decodable {
    ...
    var pointOfSale: GeoCoordinateTypeV1?
    ...
    init(from decoder: inout UPERDecoder) throws {
        ...
        if presence[9] { extensionData = try ExtensionDataV1(from: &decoder) }
        ...
        if presence[13] { pointOfSale = try GeoCoordinateTypeV1(from: &decoder) }
...
extension IssuingDataV1: ASN1Encodable {
