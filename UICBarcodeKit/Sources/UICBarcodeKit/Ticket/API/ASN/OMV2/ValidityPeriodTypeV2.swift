...
struct ValidityPeriodTypeV2: ASN1Decodable {
    ...
    init(from decoder: inout UPERDecoder) throws {
        // No extension marker
        // 6 optional+default fields (validFromDay(D), validUntilDay(D) + 2 optional + 2 new UTCOffset)
...
extension ValidityPeriodTypeV2: ASN1Encodable {
