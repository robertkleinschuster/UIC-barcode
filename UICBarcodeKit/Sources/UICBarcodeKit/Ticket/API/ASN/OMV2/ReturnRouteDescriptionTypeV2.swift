...
struct ReturnRouteDescriptionTypeV2: ASN1Decodable {
    ...
    var validReturnRegion: [RegionalValidityTypeV2]?
...
extension ReturnRouteDescriptionTypeV2: ASN1Encodable {
    func encode(to encoder: inout UPEREncoder) throws {
        ...
        if let v = validReturnRegion { try encoder.encodeSequenceOf(v) }
    }
}
