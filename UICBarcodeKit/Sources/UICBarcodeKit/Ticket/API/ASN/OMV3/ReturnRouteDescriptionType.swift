...
public struct ReturnRouteDescriptionType: ASN1Decodable {
    ...
    public var validReturnRegionDesc: String?
    public var validReturnRegion: [RegionalValidityType]?
...
extension ReturnRouteDescriptionType: ASN1Encodable {
